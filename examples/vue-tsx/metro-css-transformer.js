...
// its own @symbiote/css-parser devDependency: @symbiote/vue/metro-css-parser re-exports it from
...
const { createCssMetroTransformer } = require('@symbiote/vue/metro-css-parser');
