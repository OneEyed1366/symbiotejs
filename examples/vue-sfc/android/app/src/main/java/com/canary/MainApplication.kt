...
// hand-maintained — each key string must match that sensor's own `definition() { Name("...") }`
// exactly, or requireNativeModule(...) fails at RUNTIME (`Cannot find native module`), not build
// time (see the symbiote-expo-native-module skill).
