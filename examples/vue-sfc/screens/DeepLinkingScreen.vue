      ...
      <View class="hero-card">
        ...
        <View class="hero-copy">
          ...
          <Text class="hero-body"
            >A typed URL resolved to a route through resolveRouteFromUrl, the same path a
            real deep link or push notification would take.</Text
          >
        </View>
      </View>
      <Text class="info-text"
        >prefixes: symbiotecanaryvuesfc:// · https://canary.symbiote-native.dev</Text
      >
