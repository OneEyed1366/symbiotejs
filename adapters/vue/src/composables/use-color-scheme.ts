...
// (@symbiotejs/engine). Idiomatic Vue: returns a Ref the template unwraps, seeded from the
...
import { Appearance, type IColorSchemeName, type IEventSubscription } from '@symbiotejs/engine';
