...
// live in @symbiotejs/engine (shared verbatim with every adapter); React supplies only the
...
import type { IStatusBarImperative, IStatusBarProps } from '@symbiotejs/engine';
export type { IStatusBarProps, IStatusBarStyle, IStatusBarAnimation } from '@symbiotejs/engine';
