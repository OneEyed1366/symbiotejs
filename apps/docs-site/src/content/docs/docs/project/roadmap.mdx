---
title: Roadmap
description: Current status and the next milestones for symbiote.
---
...
point over the same `@symbiotejs/engine` core.

## Styling / CSS compiler

`@symbiotejs/css-parser` compiles plain CSS, CSS Modules, and SCSS/Sass, Less,
...
in-editor autocomplete — see the [styling guide](/symbiote/docs/learn/styling/) for
