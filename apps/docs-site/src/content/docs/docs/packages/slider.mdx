...
explicit form. See the [Vue API reference](/symbiotejs/docs/api/vue/#model-bindings-v-model).
...
a Vue scoped slot) — see [shared vs framework-specific](/symbiotejs/docs/api/components/#shared-vs-framework-specific).
...
[how it works](/symbiotejs/docs/how-it-works/)). Wrapping a different third-party native view follows this
exact recipe; see
[decision 0027](https://github.com/OneEyed1366/symbiotejs/blob/main/.docs/decisions/0027-third-party-native-view-wrapper-package.md)
