---
title: Styling
description: Style Symbiote native views with CSS classes, CSS Modules, or StyleSheet.create.
---

Symbiote's preferred way to style a native view is ordinary CSS — a class
...
[`examples/vue-sfc/App.vue`](https://github.com/OneEyed1366/symbiote/blob/master/examples/vue-sfc/App.vue)
...
misapplied. Tailwind CSS and a Svelte adapter are not supported — Symbiote
