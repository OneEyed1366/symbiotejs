...
<Aside type="caution" title="One deliberate exception">
  ...
  packages have followed: [Slider](/symbiotejs/docs/packages/slider/) ships an Angular
  build too — see the [status page](/symbiotejs/docs/project/status/) for the exact
  line.
</Aside>
...
Read the exact API surface in the [Angular API reference](/symbiotejs/docs/api/angular/).
