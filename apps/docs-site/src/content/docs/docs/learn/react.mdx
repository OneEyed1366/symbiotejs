---
title: React guide
description: How to write Symbiote apps with the React adapter.
---
...
`symbiote`'s shared engine instead of React Native's own Fabric host config.
...
Read the exact API surface in the [React API reference](/symbiote/docs/api/react/).
