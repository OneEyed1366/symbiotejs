...
<img src="/vue-demo.gif" alt="Vue SFC driving a native symbiote demo" width="260" />

*Vue SFC (`.vue`) — the reference canary at `examples/vue-sfc`.*

<img src="/vue-tsx-demo.gif" alt="Vue TSX driving a native symbiote demo" width="260" />
