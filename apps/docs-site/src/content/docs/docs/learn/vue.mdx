...
[Styling guide](/symbiotejs/docs/learn/styling/) for both paths.
...
- controlled-value components (`Switch`, `TextInput`, the [Slider](/symbiotejs/docs/packages/slider/)
...
Read the exact API surface in the [Vue API reference](/symbiotejs/docs/api/vue/).
