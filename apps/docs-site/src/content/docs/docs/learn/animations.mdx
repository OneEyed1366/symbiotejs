...
[`examples/react/App.tsx`](https://github.com/OneEyed1366/symbiotejs/blob/master/examples/react/App.tsx)'s
...
[wrapped third-party native view](/symbiotejs/docs/howtos/third-party-views/) would.
