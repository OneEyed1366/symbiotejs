...
```tsx
import { Animated } from '@symbiotejs/react'; // or '@symbiotejs/vue' / '@symbiotejs/angular'
...
optional). See the [Animations guide](/symbiotejs/docs/learn/animations/) for the full
...
[`examples/react/App.tsx`](https://github.com/OneEyed1366/symbiotejs/blob/master/examples/react/App.tsx).
