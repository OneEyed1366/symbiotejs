...
<Aside type="caution" title="Same-surface only, permanently">
  ...
  never implements the mutation-mode container ops it needs). Symbiote's React
...
[`react-adapter-portal`](https://github.com/OneEyed1366/symbiote/blob/master/.claude/skills/react-adapter-portal/SKILL.md),
[`vue-adapter-directives`](https://github.com/OneEyed1366/symbiote/blob/master/.claude/skills/vue-adapter-directives/SKILL.md),
and
[`angular-adapter-portal`](https://github.com/OneEyed1366/symbiote/blob/master/.claude/skills/angular-adapter-portal/SKILL.md).
