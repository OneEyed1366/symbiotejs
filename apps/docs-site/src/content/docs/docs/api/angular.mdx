...
[Core API](/symbiotejs/docs/api/core/#app-entry-point-appregistry). One Angular-specific
...
[Animations guide](/symbiotejs/docs/learn/animations/) for the full surface and why the
named exports exist.
...
instead — see the [Slider package](/symbiotejs/docs/packages/slider/) for the reference
