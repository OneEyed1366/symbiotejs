...
Symbiote's component goal is structural parity: reusable state, render, and
...
- `Animated` — The value graph is shared; component wrapping differs by
  adapter (see the [Animations guide](/symbiote/docs/learn/animations/)).
...
6. platform notes;
7. parity notes explaining what lives in `@symbiotejs/components`.
