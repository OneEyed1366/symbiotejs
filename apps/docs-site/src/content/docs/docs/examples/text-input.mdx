...
import { Text, TextInput, View } from '@symbiotejs/react';
...
import { ref } from 'vue';
import { Text, TextInput, View } from '@symbiotejs/vue';
...
import { Text, TextInput, View } from '@symbiotejs/angular';
...
style objects inline — see the [Styling guide](/symbiotejs/docs/learn/styling/).
