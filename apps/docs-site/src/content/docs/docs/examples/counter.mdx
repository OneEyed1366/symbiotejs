...
description: The smallest useful Symbiote app in React, Vue, and Angular.
---
...
adapter (see the [Pressable example](/symbiote/docs/examples/pressable/)).
`StyleSheet.create` works identically to a CSS class if you'd rather keep
style objects inline — see the [Styling guide](/symbiote/docs/learn/styling/).
