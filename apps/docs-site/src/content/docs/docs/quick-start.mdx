---
title: Quick start
description: Run the existing symbiote examples and inspect the first native app driven through the shared engine.
---

:::note Run from source
symbiote is a renderer project under active development. The quickest way to try
...
The React example is the reference canary: it drives the symbiote engine through
...
Next, read [how it works](/symbiote/docs/how-it-works/) to understand the render pipeline.
