...
// responder negotiation @symbiotejs/engine's events run: the should-set gates decide who owns a
...
// side-effecting. Framework-agnostic (only ISymbioteEvent), so it lives in @symbiotejs/components
