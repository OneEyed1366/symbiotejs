// Vue lifecycle wiring over the framework-agnostic MagnetometerUncalibrated singleton (core/) —
...
export function useMagnetometerUncalibrated(
  ...
  const measurement = ref<IMagnetometerUncalibratedMeasurement | null>(null);
  ...
  onMounted(() => {
    ...
    subscription = MagnetometerUncalibrated.addListener(next => {
