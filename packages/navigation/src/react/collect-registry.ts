...
// component (isMarkerElement) and the props shape (TProps) — the walk-and-spread logic itself was
// triplicated verbatim across all three. Stays in react/ rather than core/: Children/isValidElement
// are React-only APIs (see CLAUDE.md <adapter_src_follows_framework_idioms>).
