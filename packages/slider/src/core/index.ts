// @symbiotejs/slider (core): the framework-agnostic half of the @react-native-community/slider
...
// plus the Descriptor render of the native leaf. Every adapter (`@symbiotejs/slider/vue`, and
